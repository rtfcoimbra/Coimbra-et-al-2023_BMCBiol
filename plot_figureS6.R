...
plot_tree("orientagraph.m1.r2", plus = 0.08, arrow = 0.075, cex = 0.8, flip = c(8, 14, 16, 22, 25, 28))
title(expression(paste(italic("m"), " = 1")))

plot_tree("orientagraph.m2.r9", plus = 0.08, arrow = 0.075, cex = 0.8, flip = c(7, 8, 10, 15, 16, 20, 27, 28))
title(expression(paste(italic("m"), " = 2")))

plot_resid(stem = "orientagraph.m1.r2", pop_order = "sample_sets.txt", cex = 0.45, min = -0.00144, max = 0.00144, usemax = F)
title(expression(paste("Residuals from ", italic("m"), " = 1")))

plot_resid(stem = "orientagraph.m2.r9", pop_order = "sample_sets.txt", cex = 0.45, min = -0.001425, max = 0.001425, usemax = F)
